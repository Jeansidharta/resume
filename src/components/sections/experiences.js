...
const experiences = [
	{
		title: {
			'pt-br': (
				<>
					Reponsável de Tecnologia na <Italic>TechViz</Italic>
				</>
			),
		},
		duration: {
		...
		description: {
			'pt-br': (
				<>
					...
					Diversidade, Equidade e Inclusão (DE&I). Participo dessa empresa desde a sua formação,
					...
					Terraform. Além disso, sou responsável por determinar os requisitos de negócio a partir
	...
	},
	{
		title: {
			'pt-br': (
				<>
					Desenvolvedor web no <Italic>Pronto Combustíveis</Italic>
				</>
			),
			'en-us': (
				<>
	...
	},
	{
		title: {
			'pt-br': (
				<>
					Estágio de deselvolvimento web na <Italic>AJ.Estratégia</Italic>
				</>
			),
			'en-us': (
				<>
					Web development internship at <Italic>AJ.Estratégia</Italic>
				</>
			),
		},
		duration: {
		...
		description: {
			'pt-br': (
				<>
					<Italic>AJ.Estratégia</Italic> é uma empresa de consultoria em marketing digital em São
					Carlos. Aqui, fiquei encarregado de desenvolver aplicações com foco em conversão de
					usuários. Minhas tarefas incluiam: otimizar o tempo de carregamento de páginas; coletar
					dados sobre o coportamento dos usuários; atualizar e modificar páginas para atrair mais
					clientes.
				</>
			),
			'en-us': (
				<>
					<Italic>AJ.Estratégia</Italic> is a digital marketing consultant company in São Carlos.
					Here, I was in charge of developing user-conversion oriented applications. My main tasks
					included: Optimize loading page time; collect data about user behavior; modify and update
					pages to attract more clients.
				</>
			),
		},
	},

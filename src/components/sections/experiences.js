...
const experiences = [
	{
		title: {
			'pt-br': <>Reponsável de Tecnologia na <Italic>TechViz</Italic></>,
		},
		duration: {
			'pt-br': <>2020 - hoje</>,
		},
		description: {
			'pt-br': <>
				...
				de seu produto de censo e de sua <Italic>Landing Page</Italic>. Esses projetos foram construidos
				usando React com Nextjs em Typescript e foram implantados na AWS usando Terraform. Além disso,
				sou responsável por determinar os requisitos de negócio a partir das demandas da equipe e dar
	...
	{
		title: {
			'pt-br': <>Desenvolvedor web no <Italic>Pronto Combustíveis</Italic></>,
		...
		description: {
			'pt-br': <>
				...
				para postos de bandeira branca. Minha função é participar da equipe de
				desenvolvimento front-end do sistema web interno da empresa e do aplicativo
				externo para seus clientes, utilizando técnologias como React, Typescript e GraphQL.
			</>,
			'en-us': <>
				{/* TODO - Update */}
	...
	},
	{
		...
		description: {
			'pt-br': <>
				...
				construir um aplicativo web de banco utilizando React e Redux, junto de um time composto por

...
const experiences = [
	...
	},
	{
		title: {
			...
			'en-us': (
				<>
					Software Technical Lead at <Italic>Tech Viz</Italic>
				</>
			),
		},
		duration: {
		...
		description: {
			'en-us': (
				<>
					...
					Page. Furthermore, I was responsible for determining the business requirements from the team's
	...
	},
	{
		title: {
			'en-us': (
				<>
					Mid-level web developer at <Italic>Predify</Italic>
				</>
			),
			'pt-br': (
				<>
		...
		description: {
			'en-us': (
				<>
					Predify is a pricing company for products and services. I built custom platforms for multiple customers, understanding their requirements and
		...
		description: {
			...
			'en-us': (
				<>
					...
					was to participate in a development squad for an internal application that
					managed fuel sales and cargo distribution.
				</>
			),
		},
	},
		...
		description: {
			...
			'en-us': (
				<>
					...
					as a web developer in charge of building a banking application and aiding my coworkers with their projects
				</>
			),
		},
	},
